...
export default function PostForm() {
    ...
    return (
        <div className='ml-20'>
            ...
            <div className="flex flex-col justify-start w-10/12 max-w-2xl p-4 space-y-4 rounded-md shadow-lg ">
                <Form {...form}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Textarea spellCheck={true} className='h-60' placeholder="A description can change the world...." {...field}
                    ...
                    <div className="flex justify-end buttons">
                        <Button size="lg" className="ml-2 text-gray-200 transition duration-500 bg-indigo-500 border border-indigo-500 hover:bg-transparent">Post</Button>
                    </div>
                </Form>
            </div >
        </div >

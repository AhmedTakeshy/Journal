...
export default async function Profile() {
    ...
    console.log("🚀 ~ file: Profile.tsx:16 ~ Profile ~ posts, user:", posts, user)
    return (
        <div >
            ...
            backgroundImage: 'url("https://images.unsplash.com/photo-1499336315816-097655dcfbda?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=2710&amp;q=80")'}}>
                    <span id="blackOverlay" className="w-full h-full absolute opacity-50 dark:bg-black"></span>
                </div>
            ...
            <section className="relative py-16">
                <div className="container mx-auto px-4">
                    <div className="relative flex flex-col min-w-0 break-words bg-white dark:bg-slate-700 w-full mb-6 shadow-xl rounded-lg -mt-64">
                        <div className="px-6">
                            <div className="flex flex-wrap justify-center">
                                <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                                    <Image width={150} height={150} src={image && !image.includes("fbsbx") ? image : avatar} alt={`${session?.user?.name} pic`} className=" w-32 h-32 shadow-xl rounded-full border-none relative bottom-16 left-20  max-w-xs object-contain"/>
                                </div>

...
export default function Post() {
    return (
    <>
            <div className="max-w-screen-md p-4 mt-6 border dark:bg-slate-700 bg-slate-200 rounded-2xl">
                <div className="flex items-center justify-between">
                    <div className="gap-3.5	flex items-center ">
                        <img src="https://images.unsplash.com/photo-1617077644557-64be144aa306?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" className="object-cover w-10 h-10 bg-yellow-500 rounded-full" />
                        <div className="flex flex-col">
                            <b className="mb-2 capitalize">sofia müller</b>
                            <time dateTime="06-08-21" className="text-xs text-gray-400">06 August at 09.15 PM
                            </time>
                        </div>
                    </div>
                ...
                <div className="flex flex-wrap justify-center gap-2 pb-4 mt-5 border-b ">
                    <img src="https://images.unsplash.com/photo-1610147323479-a7fb11ffd5dd?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1534&q=80" className="flex-auto object-cover w-1/3 bg-red-500 rounded-2xl h-96" alt="photo"/>
                        ...
                        <div className="flex items-center justify-around h-10 border-b ">
                            ...
                            <div className="flex items-center gap-3">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-red-500" viewBox="0 0 20 20"
                                    fill="currentColor">
                        ...
                        <div className="flex items-center justify-between mt-4">
                            <img src="https://images.unsplash.com/photo-1595152452543-e5fc28ebc2b8?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" className="object-cover w-10 h-10 bg-yellow-500 border rounded-full" />

...
export default async function Post({ authorName, authorImage, date, title, topic, content }: Props) {
    ...
    return (
        <>
            <div className="w-full max-w-screen-md p-4 mt-6 border dark:bg-slate-700 bg-slate-200 rounded-2xl">
                ...
                <span className="">#<b className="mb-2 text-blue-400">{topic}</b></span>
                <p className="w-full mt-8 mb-2 text-center">{content}</p>
                ...
                {/* <div className="flex items-center justify-around h-10 border-b ">
                    <div className="flex items-center gap-3 ">
                        <svg width="20px" height="19px" viewBox="0 0 20 19" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <g id="?-Social-Media" stroke="none" strokeWidth="1" fill="none" fill-rule="evenodd">
